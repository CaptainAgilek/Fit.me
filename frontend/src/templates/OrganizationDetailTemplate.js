    ...
    return (
        <>
            ...
            {state.showData &&
                console.log(
                    mapProvider.search({
                        query: organizationFetcher.data.organization.places[0].city,
                    })
                )}
            {state.showData && (
                <>
                        ...
                        <Row className="justify-content-center organization-profile-section-container">
                            <Col xl={4} className="organization-detail-info">
                                <Row>
                                    ...
                                    >
                                        {organizationFetcher.data.organization.photo_gallery.map(
                                            (photo) => (
                                                <Carousel.Item>
                                ...
                                <Row>
                                    ...
                                    <Col className="organization-detail-carousel-container">
                                        ...
                                        <Row className="organization-detail-info-line">
                                            <Col xl={1}>
                                                <Image
                                                    src="/images/icons/phone-alt-solid.svg"
                                                    fluid
                                                ></Image>
                                            </Col>
                                        ...
                                        <Row className="organization-detail-info-line">
                                            <Col xl={1}>
                                                <Image src="/images/icons/mail.svg" fluid></Image>
                                            </Col>
                                        ...
                                        <Row className="organization-detail-info-line">
                                            <Col xl={1}>
                                                <Image
                                                    src="/images/icons/external-link-alt-solid.svg"
                                                    fluid
                                                ></Image>
                                            </Col>
                                        ...
                                        <Row className="organization-detail-info-line">
                                            <Col xl={1}>
                                                <Image
                                                    src="/images/icons/check-circle-regular.svg"
                                                    fluid
                                                ></Image>
                                            </Col>
                      Možnost uplatnění&nbsp;
                      {organizationFetcher.data.organization.acceptedBenefits.map(
                            ...
                            <Col xl={4} className="organization-detail-info">
                                ...
                                {locationState && (
                                    ...
                                    >
                                        ...
                                        />
                                        <Marker
                                            position={[locationState.y, locationState.x]}
                                        ></Marker>
                                    </MapContainer>
                                )}
                            </Col>
                        ...
                        <Row className="justify-content-center ">
                            <Col lg={10} className="organization-detail-actions">
                                ...
                                <Row className="justify-content-center ">
                                    <Col lg={5}>
                                        <hr class="organization-detail-actions-hr"></hr>
                                    </Col>
                                </Row>
                                <Row className="justify-content-center ">
                        ...
                        <Row className="organization-profile-section-container justify-content-center">
                            <Col lg={10} className="organization-detail-trainers">
                                ...
                                <Row className="justify-content-center ">
                                    <Col lg={5}>
                                        <hr class="organization-detail-trainers-hr"></hr>
                                    </Col>
                                </Row>
                                <Row
