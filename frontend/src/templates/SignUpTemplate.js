  ...
  return (
    <>
      ...
      <Formik
        ...
        validateOnBlur={true}
        validationSchema={registrationType === 'ORGANIZATION' ? organizationSchema : userSchema}
      >
        {({ errors, touched, handleSubmit }) => (
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Row className={'justify-content-md-center radio-group form-group'}>
              <Col>
                <label>
                  <Field onClick={() => setRegistrationType('SPORTSMAN')} type="radio" name="type" value="SPORTSMAN" />
                  Sportovec
                </label>
              </Col>
              <Col>
                <label>
                  <Field onClick={() => setRegistrationType('TRAINER')} type="radio" name="type" value="TRAINER" />
                  Trenér
                </label>
              </Col>
              <Col>
                <label>
                  <Field onClick={() => setRegistrationType('ORGANIZATION')} type="radio" name="type"
                         value="ORGANIZATION" />
                  Organizace
                </label>
              </Col>
            ...
            {registrationType === 'ORGANIZATION' ? <OrganizationRegistration /> : <UserRegistration />}
