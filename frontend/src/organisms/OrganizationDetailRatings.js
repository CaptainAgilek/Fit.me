...
export function OrganizationDetailRatings({
  ratings,
  userData,
  organizationFetcher,
}) {
  ...
  const [addRatingHandler] = useMutation(ADD_RATING_MUTATION, {
    onCompleted: () => {
              ...
              <Card.Body>
                <Row style={{ paddingBottom: "1.5rem" }}>
                  <Col lg={4} xs={5}>
                    <Image
                      src={
                        rating.sportsman.profile_photo &&
                        rating.sportsman.profile_photo.url
                      }
                  ...
                  <Col>
                    <Row style={{ fontSize: "3vh" }}>
                      {rating.sportsman.firstname +
                        " " +
                        rating.sportsman.lastname}
                    </Row>
                    <Row>
                      {[...Array(rating.stars)].map((_, index) => (
                        <Col
                          ...
                          sm={1}
                          xs={2}
                          className="organization-detail-rating-star star-full"
                          key={index}
                        >
                          <Image src="/images/icons/star-solid.svg"></Image>
                        </Col>
                      ))}
                      {[...Array(5 - rating.stars)].map((_, index) => (
                        <Col
                          ...
                          sm={1}
                          xs={2}
                          className="organization-detail-rating-star"
                          key={index}
                        >
                          <Image src="/images/icons/star-regular.svg"></Image>
                        </Col>
                      ))}
                    </Row>
                  </Col>
          ...
          <Card.Body>
            <Row style={{ paddingBottom: "1.5rem" }}>
              <Col lg={4} xs={5}>
                <Image
                  src={
                    userData.sportsman.profile_photo
                      ? userData.sportsman.profile_photo.url
                      : DEFAULT_IMG_URL
                  }
                  style={{ maxWidth: "100%", height: "5rem" }}
                  roundedCircle
              ...
              <Col>
                <Row style={{ fontSize: "3vh" }}>
                  {userData.sportsman.firstname +
                    " " +
                    userData.sportsman.lastname}
                </Row>
                <Row>
                  {[...Array(5)].map((_, index) => (
                    <Col
                      ...
                      sm={1}
                      xs={2}
                      className={classNames("organization-detail-rating-star", {
                        "star-full": starState[index],
                      })}
                      id={index}
                      key={index}
                    >
            ...
            <Form>
              <Form.Row>
                <Form.Group name="text" controlId="text" as={Col}>
                  <Form.Control
                    as="textarea"
                    style={{
                      height: "100%",
