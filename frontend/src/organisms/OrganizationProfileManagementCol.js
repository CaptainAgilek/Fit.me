...
export function OrganizationProfileManagementCol({
  ...
  const src = organization.profile_photo ? organization.profile_photo.url : DEFAULT_IMG_URL
  ...
  const handleBannerUpload = async (selectedFile) => {
    ...
    await uploadFileHandler({
      variables: { file: selectedFile, user_id: organization.user_id, photo_id: organization.profile_photo.photo_id, type: 'BANNER' },
    });
  };
