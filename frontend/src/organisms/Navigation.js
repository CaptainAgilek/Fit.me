        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          {user ? (
            ...
            <Nav>
              ...
              {showSignIn ? (
                <SignInPage
                  onCloseMethod={setSignInVisible}
                  showSignIn={showSignIn}
                  setShowSignUp={setSignUpVisible}
                  setShowForgotten={setForgottenVisible}
                />
              ) : null}
              <Button variant="success" onClick={() => setSignUpVisible(true)}>
                REGISTRACE
              </Button>
              {showSignUp ? (
                <SignUpPage
                  onCloseMethod={setSignUpVisible}
                  showSignUp={showSignUp}
                  setShowSignIn={setSignInVisible}
                />
              ) : null}
              {showForgotten ? (
                <ForgottenPasswordPage
                  onCloseMethod={setForgottenVisible}
