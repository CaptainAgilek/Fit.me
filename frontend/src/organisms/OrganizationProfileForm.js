...
export function OrganizationProfileForm({
  ...
  const initialValues = {
    ...
    acceptMultisport: organization.acceptedBenefits.some(
      (benefit) => benefit.name === "Multisport"
    ),
    acceptActivePass: organization.acceptedBenefits.some(
        ...
        <Formik
          ...
          onSubmit={(values) => {
            const profile = {
              ...
              place: {
                place_id: organization.places[0]
                  ? organization.places[0].place_id
                  : null,
                user_id: organization.user_id,
                city: values.city,
